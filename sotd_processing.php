...
class TableData {
        ...
        public function __construct() {
                ...
                try {
                    ...
                    $this->_db = new PDO('mysql:host='.$host.';charset=utf8;dbname='.$database, $user, $passwd, array(PDO::ATTR_PERSISTENT => t$
        ...
        public function get($table, $index_column, $columns) {
                ...
                $sQuery = "SELECT SQL_CALC_FOUND_ROWS `".str_replace(" , ", " ", implode("`, `", $columns))."` FROM `".$table."` ".$sWhere." ".$
...
// Get the data
$table_data->get('sotd', 'id', array('name', 'link', 'song', 'sdate', 'dlname'));
